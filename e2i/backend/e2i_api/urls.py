...
from e2i_api.apps.common.dashboard_views import (
    ...
    user_dashboard_summary_view,
    user_upload_history_view,
    user_activity_timeline_view,
)
...
urlpatterns = [
    ...
    path("dashboard/user-summary/", user_dashboard_summary_view, name="user-dashboard-summary"),
    path("dashboard/user-uploads/", user_upload_history_view, name="user-upload-history"),
    path("dashboard/user-activity/", user_activity_timeline_view, name="user-activity-timeline"),
